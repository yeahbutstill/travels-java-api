...
class AccountControllerTest {
	 ...
	 * @since 10/12/2020
	 */
	private String getJsonPayload(String accountType)
			throws JsonProcessingException {
		
		AccountDTO dto = new AccountDTO(AccountControllerTest.ACCOUNT_ID, AccountControllerTest.ACCOUNT_NUMBER, accountType);
